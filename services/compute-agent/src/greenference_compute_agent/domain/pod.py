"""Pod lifecycle management — ProcessPodBackend and K8sPodBackend (import-gated)."""
...
from greenference_protocol import ComputeRuntimeRecord, WorkloadSpec
...
class PodBackend:
    ...
    def stop_pod(self, runtime: ComputeRuntimeRecord) -> ComputeRuntimeRecord:
        raise NotImplementedError

    def health(self, runtime: ComputeRuntimeRecord) -> dict[str, Any]:
        raise NotImplementedError

    def exec_command(self, runtime: ComputeRuntimeRecord, command: list[str]) -> str:
        raise NotImplementedError

    def stream_logs(self, runtime: ComputeRuntimeRecord) -> Iterator[str]:
        raise NotImplementedError
